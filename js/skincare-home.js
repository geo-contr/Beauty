...
// end of navbar-ის დამალვა scroll-ზე
	...
	document.addEventListener("keydown", function (e){
	  ...
	  if (e.key == "Escape"){
	    ...
	    $('.div-footer-img').removeClass('z_index z_index1 z_index2 z_index3');
	  }
	});
	...
	$("#mega-one").click(function(){
		...
		// $(".gallery-drop").fadeToggle(300);
		$(".fashion-drop, .about-drop, .contact-drop").slideUp(0);
		// $(".fashion-drop").fadeOut(0);
	    $(".gallery-li").toggleClass("active");
	    $(".fashion-li, .about-li, .contact-li").removeClass("active");
	    ...
	    $('.div-footer-img').toggleClass('z_index');
	    $('.div-footer-img').removeClass('z_index1 z_index2 z_index3');
	});
	...
	$("#mega-two").click(function(){
	    ...
	    $('.div-footer-img').toggleClass('z_index1');
	    $('.div-footer-img').removeClass('z_index z_index2 z_index3');
	});
	...
	$("#mega-three").click(function(){
		...
		$(".gallery-li, .fashion-li, .contact-li").removeClass("active");
	    ...
	    $('.div-footer-img').toggleClass('z_index2');
	    $('.div-footer-img').removeClass('z_index z_index1 z_index3');
	});
	...
	$("#mega-four").click(function(){
	    ...
	    $('.div-footer-img').toggleClass('z_index3');
	    $('.div-footer-img').removeClass('z_index z_index1 z_index2');
	});
	// end of mega-menu
});
...
var image4 = document.getElementsByClassName('img4');
...
var image6 = document.getElementsByClassName('img6');
